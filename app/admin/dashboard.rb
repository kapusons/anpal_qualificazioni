  ...
  content title: proc { I18n.t("active_admin.dashboard") } do
    ...
    div class: "blank_slate_container", id: "dashboard_default_message" do
      span class: "blank_slate" do
        span I18n.t('active_admin.dashboards.welcome').concat("<br/><br/>").concat(link_to I18n.t('active_admin.dashboards.create'),  new_admin_application_path).html_safe
      end
    end
    ...
    columns class: 'dashboard-columns' do
      column do
        panel (I18n.t('active_admin.dashboards.last_applications')).concat(link_to I18n.t('active_admin.dashboards.see_all'),  admin_applications_path, style: "float: right;").html_safe do
          @applications = Application.dashboard_for(current_admin_user).ordered_by_comment_or_status_for(current_admin_user).limit(5)
      ...
      column do
        panel (I18n.t('active_admin.dashboards.last_comments')).concat(link_to I18n.t('active_admin.dashboards.see_all'),  admin_comments_path, style: "float: right;").html_safe do
          @comments = ActiveAdmin::Comment.for_application_visible_by(current_admin_user).ordered.limit(5)
